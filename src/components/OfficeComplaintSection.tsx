...
const OfficeComplaintSection: React.FC = () => {
  ...
  return (
    <div className="p-6 bg-white rounded shadow mb-6">
      <h2 className="text-2xl font-bold mb-4">Office Complaint</h2>
      <form onSubmit={handleSubmit}>
        <textarea
          value={complaint}
          onChange={(e) => setComplaint(e.target.value)}
          className="w-full border border-gray-300 rounded p-2 mb-4"
          placeholder="Enter your office complaint here..."
          required
        ></textarea>
      ...
      <hr className="my-6" />
      <h3 className="text-xl font-semibold mb-4">Submitted Office Complaints</h3>
