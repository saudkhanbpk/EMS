...
const Leave: React.FC = () => {
  ...
  // Handle the click event to show the LeaveRequest component
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            ...
            <div className="space-y-4 text-gray-700">
              <div>
                ...
                <p>✔ Employees are entitled to <strong>22 paid annual leave days</strong> per year.</p>
                <p>✔ Any leave beyond 22 days will be unpaid.</p>
              </div>

              <div>
                <h3 className="font-semibold text-gray-800">2. Sick Leave</h3>
                <p>✔ Employees can take up to <strong>10 paid sick leave days</strong> per year.</p>
                <p>✔ A medical certificate is required if sick leave exceeds 2 consecutive days.</p>
              </div>

              <div>
                <h3 className="font-semibold text-gray-800">3. Casual Leave</h3>
                <p>✔ Employees have <strong>6 casual leave days</strong> per year.</p>
                <p>✔ Must be informed at least 1 day in advance (except emergencies).</p>
              </div>

              <div>
                <h3 className="font-semibold text-gray-800">4. Public Holidays</h3>
                <p>✔ Employees will observe all national and company-declared public holidays as paid leave.</p>
              </div>

              <div>
                <h3 className="font-semibold text-gray-800">5. Maternity & Paternity Leave</h3>
                <p>✔ Male employees are entitled to <strong>5 days of paid paternity leave</strong>.</p>
              </div>

              <div>
                <h3 className="font-semibold text-gray-800">6. Unpaid Leave</h3>
                <p>✔ Any additional leave beyond entitlement will be unpaid and require managerial approval.</p>
              </div>

              <div>
                <h3 className="font-semibold text-gray-800">7. Unauthorized Absences</h3>
                <p>✔ Absence without prior approval may lead to <strong>salary deductions</strong> or disciplinary action.</p>
              </div>

              <div>
                <h3 className="font-semibold text-gray-800">8. Emergency Leave</h3>
                <p>✔ In case of an emergency, employees must inform their manager as soon as possible.</p>
              </div>
            </div>
